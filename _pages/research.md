...
***Firm reactions to extreme weather and implications for climate change policy*** [[Latest version][jmp]{:target="_blank"}]\
...
***Climate change increases bilateral trade cost*** [[Working paper][trade_network_changes]{:target="_blank"}]\
...
***Information frictions and firm behavior: Evidence from the African Continental Free Trade Area*** (with Yewande Olapade and Socrates Majune) [[Summary of pilot results][trade_info_frictions_pedl]{:target="_blank"}]
